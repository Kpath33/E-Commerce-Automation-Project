...
public class EcommerceWebsiteAutomation{
	...
	public static ChromeDriver createDriver() {
	 ...
	 public static void main(String[] args) throws Exception { Boolean status; ChromeDriver driver = createDriver(); driver.manage().window().maximize(); // Maximize the window
